# Generated by Django 5.2 on 2025-05-30 13:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bukti_file', models.FileField(blank=True, null=True, upload_to='bukti_milestone/')),
                ('tanggal_upload', models.DateTimeField(blank=True, null=True)),
                ('is_approved', models.CharField(choices=[('belum upload', 'Belum Upload'), ('pending', 'Menunggu'), ('disetujui', 'Disetujui'), ('ditolak', 'Ditolak')], default='belum upload', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nim', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.mhs')),
                ('nip', models.ManyToManyField(to='myapp.pembimbing')),
            ],
        ),
        migrations.AddField(
            model_name='milestone',
            name='penelitian_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.penelitian'),
        ),
        migrations.CreateModel(
            name='Bimbingan',
            fields=[
                ...
                ('status', models.CharField(choices=[('sedang diperiksa', 'Sedang Diperiksa'), ('disetujui', 'Disetujui'), ('ditolak', 'Ditolak')], default='sedang diperiksa', max_length=50)),
